 ...
 * MainActivity java contains code to import DJI mobile SDK,
 * method for drone control and client.
 *
 * Import DJI SDK code from:
...
public class MainActivity extends AppCompatActivity {
    ...
    //Next three methods are needed for flight control(take off, land).
